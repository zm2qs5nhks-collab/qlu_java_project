...
| 姓名 | 学号 | 负责模块 | 贡献说明 |
|:-----|:-----|:---------|:---------|
| 曹锦文 | 202503213020 | 全栈开发 | 项目架构设计、数据库设计、所有后端接口开发、前端模板开发、POI Excel 导出、10万测试数据生成、系统测试与部署 |

> 📝 **说明**：本项目为个人独立完成，涵盖需求分析、系统设计、编码实现、测试验证全流程。
