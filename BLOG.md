...
### 2. 系统首页导航
![系统首页导航](images/系统首页导航.png)

### 3. 学生列表
![学生列表](images/学生列表.png)

### 4. 添加学生
![添加学生](images/添加学生.png)

### 5. 成绩列表 + 搜索
![成绩列表+搜索](images/成绩列表+搜索.png)

### 6. 批量录入成绩
![批量录入成绩](images/批量录入成绩.png)

### 7. 学习情况报表
![学习情况报表](images/学习情况报表.png)

### 8. 成绩分布柱状图
![成绩分布柱状图](images/成绩分布柱状图.png)

### 9. 测试数据生成工具
![测试数据生成工具](images/测试数据生成工具.png)

### 10. 导出的 Excel 报表
![导出的Excel报表](images/导出的excel报表.png)
...
![Git 提交记录](images/八.png)

### 提交历史摘要

| 提交哈希 | 提交信息 | 日期 |
|:---------|:---------|:-----|
| `20d7102` | 添加系统功能截图：10张实际运行界面图片 | 2026-06-26 |
| `ec682b7` | 将ASCII项目架构图替换为Mermaid流程图 | 2026-06-26 |
| `c5af5f2` | 删除项目简介中的评定等级信息 | 2026-06-26 |
| `0dd088b` | 修正BLOG.md中的GitHub仓库地址链接 | 2026-06-26 |
| `3311b5c` | 更新博客：添加贺俊泽为共同作者，移除学号信息 | 2026-06-26 |
| `3cbfe66` | 添加课程设计项目博客文档(README.md) | 2026-06-26 |
| `935e543` | 提交qlu-java项目作业代码 | 2026-06-26 |
...
1. **克隆仓库**
   ```bash
   git clone https://github.com/你的用户名/student_score.git
   cd student_score
   ```
